...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.RoleCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.RoleCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.RoleCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.RoleCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.RoleCountArgs>, 'cursor'>,
